# Example $match Output Bundle - 1 Patient and 1 Warning - Patient Demographics Query for Mobile (PDQm) v3.2.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Example $match Output Bundle - 1 Patient and 1 Warning**

## Example Bundle: Example $match Output Bundle - 1 Patient and 1 Warning

Profile: [PDQm Match Output Bundle Profile](StructureDefinition-IHE.PDQm.MatchParametersOut.md)

Security Label: test health data (Details: ActReason code HTEST = 'test health data')

Bundle ex-match-output-warning of type searchset
...
Entry 2 - fullUrl = https://profiles.ihe.net/ITI/PDQm/OperationOutcome-ex-match-warning.html
