# PDQm Patient Demographics Consumer Actor Implementing Match Operation Option - Patient Demographics Query for Mobile (PDQm) v3.2.0
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/ITI/PDQm/CapabilityStatement/IHE.PDQm.PatientDemographicsConsumerMatch | *Version*:3.2.0 |
