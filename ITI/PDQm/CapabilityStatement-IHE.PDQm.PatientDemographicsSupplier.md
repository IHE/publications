# PDQm Patient Demographics Supplier Actor - Patient Demographics Query for Mobile (PDQm) v3.2.0
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/ITI/PDQm/CapabilityStatement/IHE.PDQm.PatientDemographicsSupplier | *Version*:3.2.0 |
