# Audit Event for PDQm Query at Consumer - Patient Demographics Query for Mobile (PDQm) v3.2.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Audit Event for PDQm Query at Consumer**

## Resource Profile: Audit Event for PDQm Query at Consumer 

| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/ITI/PDQm/StructureDefinition/IHE.PDQm.Query.Audit.Consumer | *Version*:3.2.1 |
| Active as of 2025-11-26 | *Computable Name*:AuditPdqmQueryConsumer |

 
Defines constraints on the AuditEvent (AuditMessage) Resource for a Patient Demographics Consumer to record when it performs a Patient Demographics Query[ITI-78](./ITI-78.md). 
...
* Examples for this Profile: [AuditEvent/ex-auditPdqmQuery-consumer](AuditEvent-ex-auditPdqmQuery-consumer.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ihe.iti.pdqm|current/StructureDefinition/IHE.PDQm.Query.Audit.Consumer)
...
Other representations of profile: [CSV](StructureDefinition-IHE.PDQm.Query.Audit.Consumer.csv), [Excel](StructureDefinition-IHE.PDQm.Query.Audit.Consumer.xlsx), [Schematron](StructureDefinition-IHE.PDQm.Query.Audit.Consumer.sch) 
        ...
        "constraint" : [
          {
            ...
            "source" : "https://profiles.ihe.net/ITI/PDQm/StructureDefinition/IHE.PDQm.Query.Audit.Consumer"
          }
        ]
      },
      {
