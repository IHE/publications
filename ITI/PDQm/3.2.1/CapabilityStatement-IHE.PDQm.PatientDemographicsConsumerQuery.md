# PDQm Patient Demographics Consumer Actor Implementing Patient Search Option - Patient Demographics Query for Mobile (PDQm) v3.2.1
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/ITI/PDQm/CapabilityStatement/IHE.PDQm.PatientDemographicsConsumerQuery | *Version*:3.2.1 |
