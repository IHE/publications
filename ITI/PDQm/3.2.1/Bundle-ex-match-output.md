# Example $match Output Bundle - 1 Patient - Patient Demographics Query for Mobile (PDQm) v3.2.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Example $match Output Bundle - 1 Patient**

## Example Bundle: Example $match Output Bundle - 1 Patient

Profile: [PDQm Match Output Bundle Profile](StructureDefinition-IHE.PDQm.MatchParametersOut.md)

Security Label: test health data (Details: ActReason code HTEST = 'test health data')

Bundle ex-match-output of type searchset
