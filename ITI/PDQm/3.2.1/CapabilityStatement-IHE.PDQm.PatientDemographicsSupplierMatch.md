# PDQm Patient Demographics Supplier Actor Implementing Match Operation Option - Patient Demographics Query for Mobile (PDQm) v3.2.1
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/ITI/PDQm/CapabilityStatement/IHE.PDQm.PatientDemographicsSupplierMatch | *Version*:3.2.1 |
