# Example $match Input Parameters Where onlyCertainmatches Is Specified - Patient Demographics Query for Mobile (PDQm) v3.2.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Example $match Input Parameters Where onlyCertainmatches Is Specified**

## Example Parameters: Example $match Input Parameters Where onlyCertainmatches Is Specified
...
```json
{
  ...
  "id" : "ex-match-input-onlyCertainMatches",
  "meta" : {
    "profile" : [
