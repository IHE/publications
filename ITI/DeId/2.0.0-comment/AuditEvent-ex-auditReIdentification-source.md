# Audit Example of authorized Re-Identification at source - De-Identification Handbook v2.0.0-comment

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Audit Example of authorized Re-Identification at source**

## Example AuditEvent: Audit Example of authorized Re-Identification at source
...
**subtype**: [ISO 21089-2017 Health Record Lifecycle Events: reidentify](http://hl7.org/fhir/R4/codesystem-iso-21089-lifecycle.html#iso-21089-lifecycle-reidentify) (Re-identify Record Lifecycle Event), [FHIR Restful Interactions: read](http://hl7.org/fhir/R4/codesystem-restful-interaction.html#restful-interaction-read) (read)
...
> **entity****what**: De-Identification Algorithm Identifier for FooBar De-Identification Algorithm (Identifier: [Uniform Resource Identifier (URI)](http://terminology.hl7.org/6.2.0/NamingSystem-uri.html)/urn:uuid:bed39a2d-3212-4f24-a5c8-e4c168968057)**type**: [Entity Type for De-Identification: DeId-algorithm](CodeSystem-DeIdentificationEntityType.md#DeIdentificationEntityType-DeId-algorithm) (De-Identification Algorithm)
