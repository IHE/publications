# Audit Event for Simplified Publish ITI-105 Transaction at Recipient - Mobile access to Health Documents (MHD) v5.0.0-comment
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/ITI/MHD/StructureDefinition/IHE.MHD.SimplifiedPublish.Audit.Recipient | *Version*:5.0.0-comment |
