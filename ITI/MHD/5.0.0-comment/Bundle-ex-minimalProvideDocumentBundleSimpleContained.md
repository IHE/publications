# Provide Document Bundle with Minimal metadata of one document with sourcePatientInfo - Mobile access to Health Documents (MHD) v5.0.0-comment
...
**DocumentReference Source Patient**:[Dee Schmidt (no stated gender), DoB Unknown](#hcex-minimalProvideDocumentBundleSimpleContained/aaaaaaaa-bbbb-cccc-dddd-e00222200002/aaaaaaaa-bbbb-cccc-dddd-e00222200004)**identifier**:[Uniform Resource Identifier (URI)](http://terminology.hl7.org/6.5.0/NamingSystem-uri.html)/urn:oid:1.2.840.113556.1.8000.2554.53432.348.12973.17740.34205.4355.50220.62012 (use: usual, )**status**: Current
> **content**
