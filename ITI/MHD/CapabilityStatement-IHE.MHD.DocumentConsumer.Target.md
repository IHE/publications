# Document Consumer (client) - Target Communities Option - Mobile access to Health Documents (MHD) v4.2.5-comment

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Document Consumer (client) - Target Communities Option**

## CapabilityStatement: Document Consumer (client) - Target Communities Option 

| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/ITI/MHD/CapabilityStatement/IHE.MHD.DocumentConsumer.Target | *Version*:4.2.5-comment |
| Active as of 2026-06-16 | *Computable Name*:IHE_MHD_DocumentConsumer_Target |

 
IHE ITI Mobile access to Health Documents (MHD) - Document Consumer (client) - Target Communities Option. 

This is the **Requirements** CapabilityStatement for a [Document Consumer](1331_actors_and_transactions.md#133112-document-consumer) implementing the [Target Communities Option](1332_actor_options.md#13327-target-communities-option). The Document Consumer may declare the UnContained References [Options](1332_actor_options.md). This Actor is allowed to use [Find Document List ITI-66](ITI-66.md), [Find Document References ITI-67](ITI-67.md), and [Retrieve Document ITI-68](ITI-68.md) transactions. The Document Consumer Actor should be robust for unconstrained DocumentReference and List Resources, as the results returned to the Document Consumer from the Document Responder may not follow the conformance constraints.

**Figure: Query Actors Interactions**

 [Raw OpenAPI-Swagger Definition file](IHE.MHD.DocumentConsumer.Target.openapi.json) | [Download](IHE.MHD.DocumentConsumer.Target.openapi.json) 
...
```json
{
  ...
  "id" : "IHE.MHD.DocumentConsumer.Target",
  "url" : "https://profiles.ihe.net/ITI/MHD/CapabilityStatement/IHE.MHD.DocumentConsumer.Target",
  "version" : "4.2.5-comment",
  "name" : "IHE_MHD_DocumentConsumer_Target",
  "title" : "Document Consumer (client) - Target Communities Option",
  "status" : "active",
  "experimental" : false,
