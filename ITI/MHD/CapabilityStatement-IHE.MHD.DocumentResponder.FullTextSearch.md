# Document Responder (server) with Full-Text Search Option - Mobile access to Health Documents (MHD) v4.2.5-comment

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Document Responder (server) with Full-Text Search Option**

## CapabilityStatement: Document Responder (server) with Full-Text Search Option 

| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/ITI/MHD/CapabilityStatement/IHE.MHD.DocumentResponder.FullTextSearch | *Version*:4.2.5-comment |
| Active as of 2026-06-16 | *Computable Name*:IHE_MHD_DocumentResponder_FullTextSearch |

 
IHE ITI Mobile access to Health Documents (MHD) - Document Responder (server) - with Full-Text Search Option. 

This is the **Requirements** CapabilityStatement for a [Document Responder](1331_actors_and_transactions.md#133114-document-responder). The Document Responder may declared the [XDS on FHIR](1332_actor_options.md#13322-xds-on-fhir-option) Option or the UnContained References [Options](1332_actor_options.md). This Actor Shall provide server implementing [Find Document List ITI-66](ITI-66.md), [Find Document References ITI-67 with Full-Text Search Option](ITI-67.md), and [Retrieve Document ITI-68](ITI-68.md) transactions.

**Figure: Query Actors Interactions**

 [Raw OpenAPI-Swagger Definition file](IHE.MHD.DocumentResponder.FullTextSearch.openapi.json) | [Download](IHE.MHD.DocumentResponder.FullTextSearch.openapi.json) 
...
```json
{
  ...
  "id" : "IHE.MHD.DocumentResponder.FullTextSearch",
  "url" : "https://profiles.ihe.net/ITI/MHD/CapabilityStatement/IHE.MHD.DocumentResponder.FullTextSearch",
  "version" : "4.2.5-comment",
  "name" : "IHE_MHD_DocumentResponder_FullTextSearch",
  "title" : "Document Responder (server) with Full-Text Search Option",
  "status" : "active",
  "experimental" : false,
