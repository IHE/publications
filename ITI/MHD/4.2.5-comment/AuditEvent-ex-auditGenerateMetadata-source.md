# Audit Example of ITI-106 at source - Mobile access to Health Documents (MHD) v4.2.5-comment
...
| :--- | :--- | :--- | :--- |
| - | **What** | **Type** | **Role** |
| * | [Binary: text/plain (16 bytes base64)](Binary-ex-binary.md) | [Audit event entity type: 2](http://terminology.hl7.org/7.2.0/CodeSystem-audit-entity-type.html#audit-entity-type-2)(System Object) | [AuditEventEntityRole: 4](http://terminology.hl7.org/7.2.0/CodeSystem-object-role.html#object-role-4)(Domain Resource) |
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://profiles.ihe.net/ITI/MHD/StructureDefinition/IHE.MHD.GenerateMetadata.Audit.Source"],
    "security" : [{
