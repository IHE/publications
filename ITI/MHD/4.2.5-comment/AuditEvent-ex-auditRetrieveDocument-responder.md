# Audit Example of ITI-68 at responder - Mobile access to Health Documents (MHD) v4.2.5-comment
...
| :--- | :--- | :--- | :--- |
| - | **Site** | **Observer** | **Type** |
| * | server.example.com | http://server.example.com/fhir | [Audit Event Source Type: 4](http://terminology.hl7.org/7.2.0/CodeSystem-security-source-type.html#security-source-type-4)(Application Server) |

> **entity****what**: [http://example.org/blah/blah.pdf](http://example.org/blah/blah.pdf)**type**: [Audit event entity type: 2](http://terminology.hl7.org/7.2.0/CodeSystem-audit-entity-type.html#audit-entity-type-2) (System Object)**role**: [AuditEventEntityRole: 3](http://terminology.hl7.org/7.2.0/CodeSystem-object-role.html#object-role-3) (Report)
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://profiles.ihe.net/ITI/MHD/StructureDefinition/IHE.MHD.RetrieveDocument.Audit.Responder"],
    "security" : [{
