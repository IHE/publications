# MHD SubmissionSet Minimal - Mobile access to Health Documents (MHD) v4.2.5-comment
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/ITI/MHD/StructureDefinition/IHE.MHD.Minimal.SubmissionSet | *Version*:4.2.5-comment |
| Active as of 2026-06-16 | *Computable Name*:SubmissionSet |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ihe.iti.mhd|current/StructureDefinition/StructureDefinition-IHE.MHD.Minimal.SubmissionSet.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "mapping" : [{
        "identity" : "SubmissionSet-Mapping",
        "map" : "SubmissionSet.homeCommunityId"
      }]
    },
    {
    ...
    },
    {
      ...
      "definition" : "The XDS UniqueId for the SubmissionSet. Globally unique identifier for the SubmissionSet assigned by the creating entity.",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Identifier",
        "profile" : ["https://profiles.ihe.net/ITI/MHD/StructureDefinition/IHE.MHD.SubmissionSetUniqueIdIdentifier"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "path" : "List.identifier",
      "sliceName" : "entryUUID",
      "short" : "SubmissionSet.entryUUID",
      "definition" : "The XDS entryUUID for the SubmissionSet. A globally unique identifier used to identify the XDS SubmissionSet in ebRIM.",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Identifier",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://profiles.ihe.net/ITI/MHD/StructureDefinition/ihe-authorOrg"]
      }],
      "mapping" : [{
        "identity" : "SubmissionSet-Mapping",
