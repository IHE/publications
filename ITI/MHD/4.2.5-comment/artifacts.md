# Artifacts Summary - Mobile access to Health Documents (MHD) v4.2.5-comment
...
| [Document Consumer (client) - Target Communities Option](CapabilityStatement-IHE.MHD.DocumentConsumer.Target.md) | IHE ITI Mobile access to Health Documents (MHD) - Document Consumer (client) - Target Communities Option. |
| [Document Consumer (client) with Full-Text Search Option](CapabilityStatement-IHE.MHD.DocumentConsumer.FullTextSearch.md) | IHE ITI Mobile access to Health Documents (MHD) - Document Consumer (client) - with Full-Text Search Option. |
...
| [Document Responder (server) - Target Communities Option](CapabilityStatement-IHE.MHD.DocumentResponder.Target.md) | IHE ITI Mobile access to Health Documents (MHD) - Document Responder (server) - Target Communities Option. |
| [Document Responder (server) with Full-Text Search Option](CapabilityStatement-IHE.MHD.DocumentResponder.FullTextSearch.md) | IHE ITI Mobile access to Health Documents (MHD) - Document Responder (server) - with Full-Text Search Option. |
...
| [search on the IHE defined extension for homeCommunityId](SearchParameter-IHE-TargetCommunityIdList.md) | This SearchParameter enables finding by the homeCommunityId where DocumentReference, submissionSet, or folder exist. |
...
| [MHD Find Document References Response message with Full-Text Search Option](StructureDefinition-IHE.MHD.FindDocumentReferencesResponseMessageFullTextSearch.md) | A profile on the Find Document References Response message for ITI-67 with Full-Text Search Option |
...
| [Full-Text Search Match Snippet](StructureDefinition-ihe-full-text-search-match-snippet.md) | This extension contains a text snippet describing the context of a full-text search match. It highlights relevant content that corresponds to the provided search terms and provides a concise preview of the search result. |
| [Full-Text Search Match Total Hits](StructureDefinition-ihe-full-text-search-match-total-hits.md) | This extension contains the total number of full-text search matches found within a document (e.g. a PDF). |
...
| [The homeCommunityId where the artifact resides](StructureDefinition-ihe-HomeCommunityId.md) | The globally unique, immutable, identifier of the homeCommunityId entity where this artifact resides. The format of the value is an OID. |
...
| | |
| :--- | :--- |
| [IHE MHD Identifier Types ValueSet](ValueSet-IHE.MHD.MHDIdentifierTypeVS.md) | ValueSet for Identifier.type values defined in IHE MHD |
...
| | |
| :--- | :--- |
| [IHE MHD Identifier Types](CodeSystem-IHE.MHD.MHDIdentifierType.md) | Code System for Identifier.type values defined in IHE MHD |
...
| [Example of a Find Document References Response Message](Bundle-ex-findDocumentReferencesResponse.md) | Example of a Find Document References Bundle Search Set with minimal DocumentReference, and one with a homeCommunityId value populated. |
| [Example of a Find Document References Response Message with the Full-Text Search Option](Bundle-ex-findDocumentReferencesResponseFullTextSearch.md) | Example of a Find Document References Bundle search set containing a single DocumentReference and using the Full-Text Search Option |
