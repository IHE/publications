# Provide Document Bundle with Comprehensive metadata of one document which replaces another document - Mobile access to Health Documents (MHD) v4.2.5-comment
    ...
    "resource" : {
      ...
      "content" : [{
        "attachment" : {
          ...
          "size" : 24,
          "hash" : "6OMXIUMAFYfLdQhEaqCS61GZWAk=",
