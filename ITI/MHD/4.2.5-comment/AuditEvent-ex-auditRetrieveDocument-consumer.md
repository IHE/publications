# Audit Example of ITI-68 at consumer - Mobile access to Health Documents (MHD) v4.2.5-comment
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://profiles.ihe.net/ITI/MHD/StructureDefinition/IHE.MHD.RetrieveDocument.Audit.Consumer"],
    "security" : [{
