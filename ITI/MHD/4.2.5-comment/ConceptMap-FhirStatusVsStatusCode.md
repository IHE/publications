# FHIR status vs ebRIM Status Type Code - Mobile access to Health Documents (MHD) v4.2.5-comment
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/ITI/MHD/ConceptMap/FhirStatusVsStatusCode | *Version*:4.2.5-comment |
