# Document Responder (server) - Target Communities Option - Mobile access to Health Documents (MHD) v4.2.5-comment

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Document Responder (server) - Target Communities Option**

## CapabilityStatement: Document Responder (server) - Target Communities Option 

| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/ITI/MHD/CapabilityStatement/IHE.MHD.DocumentResponder.Target | *Version*:4.2.5-comment |
| Active as of 2026-06-16 | *Computable Name*:IHE_MHD_DocumentResponder_Target |

 
IHE ITI Mobile access to Health Documents (MHD) - Document Responder (server) - Target Communities Option. 

This is the **Requirements** CapabilityStatement for a [Document Responder](1331_actors_and_transactions.md#133114-document-responder) implementing the [Target Communities Option](1332_actor_options.md#13327-target-communities-option). The Document Responder may declare the [XDS on FHIR](1332_actor_options.md#13322-xds-on-fhir-option) Option or the UnContained References [Options](1332_actor_options.md). This Actor SHALL provide a server implementing [Find Document List ITI-66](ITI-66.md), [Find Document References ITI-67](ITI-67.md), and [Retrieve Document ITI-68](ITI-68.md) transactions.

**Figure: Query Actors Interactions**

 [Raw OpenAPI-Swagger Definition file](IHE.MHD.DocumentResponder.Target.openapi.json) | [Download](IHE.MHD.DocumentResponder.Target.openapi.json) 
...
```json
{
  ...
  "id" : "IHE.MHD.DocumentResponder.Target",
  "url" : "https://profiles.ihe.net/ITI/MHD/CapabilityStatement/IHE.MHD.DocumentResponder.Target",
  "version" : "4.2.5-comment",
  "name" : "IHE_MHD_DocumentResponder_Target",
  "title" : "Document Responder (server) - Target Communities Option",
  "status" : "active",
  "experimental" : false,
  ...
  "rest" : [{
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "definition" : "https://profiles.ihe.net/ITI/MHD/SearchParameter/IHE-TargetCommunityIdList",
        "type" : "uri",
        "documentation" : "This SearchParameter enables finding by the homeCommunityId where DocumentReference, submissionSet, or folder exist."
      }]
    },
    {
      "type" : "List",
