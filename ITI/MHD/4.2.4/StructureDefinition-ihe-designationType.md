# Clinical code of the List - Mobile access to Health Documents (MHD) v4.2.4
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/ITI/MHD/StructureDefinition/ihe-designationType | *Version*:4.2.4 |
