# Document Source (publisher) implementing the Simplified Publish Option - Mobile access to Health Documents (MHD) v4.2.4
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/ITI/MHD/CapabilityStatement/IHE.MHD.DocumentSource.Simplified | *Version*:4.2.4 |
| Active as of 2026-06-15 | *Computable Name*:IHE_MHD_DocumentSource_Simplified |
