# Document Consumer (client) - Mobile access to Health Documents (MHD) v4.2.5-comment
...
```json
{
  ...
  "rest" : [{
    ...
    "resource" : [{
      ...
      "supportedProfile" : ["https://profiles.ihe.net/ITI/MHD/StructureDefinition/IHE.MHD.Minimal.DocumentReference"],
      "interaction" : [{
        "code" : "read"
      },
      {
    ...
    {
      "type" : "List",
      "supportedProfile" : ["https://profiles.ihe.net/ITI/MHD/StructureDefinition/IHE.MHD.List"],
      "interaction" : [{
        "code" : "read"
      },
      {
