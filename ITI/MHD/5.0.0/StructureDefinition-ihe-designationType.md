# Clinical code of the List - Mobile access to Health Documents (MHD) v5.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/ITI/MHD/StructureDefinition/ihe-designationType | *Version*:5.0.0 |
