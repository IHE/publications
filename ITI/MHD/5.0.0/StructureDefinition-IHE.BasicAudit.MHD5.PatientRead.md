# Basic AuditEvent for a successful Read with a Patient - Mobile access to Health Documents (MHD) v5.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/ITI/MHD/StructureDefinition/IHE.BasicAudit.MHD5.PatientRead | *Version*:5.0.0 |
| Active as of 2025-12-18 | *Computable Name*:PatientRead |
