# Holds values from DocumentEntry.referenceIdList that are not appropriate for .context or .basedOn - Mobile access to Health Documents (MHD) v5.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/ITI/MHD/StructureDefinition/ihe-referenceId | *Version*:5.0.0 |
| Active as of 2025-12-18 | *Computable Name*:ReferenceId |
