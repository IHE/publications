# Audit Example of ITI-94 for Patient Identity Registry for Subscription Read - Patient Master Identity Registry (PMIR) v1.6.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Audit Example of ITI-94 for Patient Identity Registry for Subscription Read**

## Example AuditEvent: Audit Example of ITI-94 for Patient Identity Registry for Subscription Read

Profile: [Audit Event for Subscribe to Patient Updates Transaction by the Patient Identity Subscriber and Registry for Read](StructureDefinition-IHE.PMIR.Audit.Subscription.Read.md)
...
**subtype**: unknown: ITI-94 (Subscribe to Patient Updates), [FHIR Restful Interactions: read](http://hl7.org/fhir/R4/codesystem-restful-interaction.html#restful-interaction-read) (read)
...
> **agent****type**:Source Role ID**who**:[Device](Device-ex-pmir.md)**requestor**: false
...
> **agent****type**:information recipient**who**: Identifier:`http://example.org/practitioner`/1234567890**requestor**: true
...
```json
{
  ...
  "id" : "ex-auditPmirSubscription-registry-read",
  "meta" : {
    "profile" : [
      "https://profiles.ihe.net/ITI/PMIR/StructureDefinition/IHE.PMIR.Audit.Subscription.Read"
    ]
  },
  "type" : {
