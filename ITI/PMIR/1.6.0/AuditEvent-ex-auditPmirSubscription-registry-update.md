# Audit Example of ITI-94 for Patient Identity Registry for Subscription Update - Patient Master Identity Registry (PMIR) v1.6.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Audit Example of ITI-94 for Patient Identity Registry for Subscription Update**

## Example AuditEvent: Audit Example of ITI-94 for Patient Identity Registry for Subscription Update
...
```json
{
  ...
  "id" : "ex-auditPmirSubscription-registry-update",
  "meta" : {
    "profile" : [
