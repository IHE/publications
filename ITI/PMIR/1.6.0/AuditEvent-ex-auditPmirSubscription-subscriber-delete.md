# Audit Example of ITI-94 for Patient Identity Subscriber for Delete - Patient Master Identity Registry (PMIR) v1.6.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Audit Example of ITI-94 for Patient Identity Subscriber for Delete**

## Example AuditEvent: Audit Example of ITI-94 for Patient Identity Subscriber for Delete

Profile: [Audit Event for Subscribe to Patient Updates Transaction by the Patient Identity Subscriber and Registry for Delete](StructureDefinition-IHE.PMIR.Audit.Subscription.Delete.md)
...
**subtype**: [FHIR Restful Interactions: delete](http://hl7.org/fhir/R4/codesystem-restful-interaction.html#restful-interaction-delete) (delete), unknown: ITI-94 (Subscribe to Patient Updates)
...
> **agent****type**:Custodian**who**:[Device](Device-ex-pmir.md)**requestor**: false
...
```json
{
  ...
  "id" : "ex-auditPmirSubscription-subscriber-delete",
  "meta" : {
    "profile" : [
