# Audit Example of ITI-94 for Patient Identity Subscriber for Create - Patient Master Identity Registry (PMIR) v1.6.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Audit Example of ITI-94 for Patient Identity Subscriber for Create**

## Example AuditEvent: Audit Example of ITI-94 for Patient Identity Subscriber for Create
...
```json
{
  ...
  "id" : "ex-auditPmirSubscription-subscriber-create",
  "meta" : {
    "profile" : [
