# Audit Example of ITI-94 for Patient Identity Subscriber for Read - Patient Master Identity Registry (PMIR) v1.6.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Audit Example of ITI-94 for Patient Identity Subscriber for Read**

## Example AuditEvent: Audit Example of ITI-94 for Patient Identity Subscriber for Read
...
```json
{
  ...
  "id" : "ex-auditPmirSubscription-subscriber-read",
  "meta" : {
    "profile" : [
