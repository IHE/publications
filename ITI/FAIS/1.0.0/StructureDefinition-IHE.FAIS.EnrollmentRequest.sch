...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:EnrollmentRequest">
      ...
      <sch:assert test="count(f:extension[@url = 'https://profiles.ihe.net/ITI/FAIS/StructureDefinition/request-statusReason']) &lt;= 1">extension with URL = 'https://profiles.ihe.net/ITI/FAIS/StructureDefinition/request-statusReason': maximum cardinality of 'extension' is 1</sch:assert>
