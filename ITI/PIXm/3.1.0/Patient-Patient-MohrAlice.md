# Patient Alice Mohr - Patient Identifier Cross-referencing for mobile (PIXm) v3.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Patient Alice Mohr**

## Example Patient: Patient Alice Mohr

Profiles: [PIXm Patient Profile example for additional Manager constraints](StructureDefinition-IHE.PIXm.Patient.BirthDateRequired.md), [PIXm Patient constraints for Feed](StructureDefinition-IHE.PIXm.Patient.md)
...
| :--- | :--- |
| Active: | true |
| Other Ids: | * `urn:oid:1.3.6.1.4.1.21367.13.20.2000`/IHEGREEN-994
* `urn:oid:1.3.6.1.4.1.21367.13.20.1000`/IHERED-994
 |
