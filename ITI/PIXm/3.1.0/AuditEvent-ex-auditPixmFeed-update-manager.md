# Audit Example of ITI-104 Update at Manager - Patient Identifier Cross-referencing for mobile (PIXm) v3.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Audit Example of ITI-104 Update at Manager**

## Example AuditEvent: Audit Example of ITI-104 Update at Manager

Profile: [Audit Event for Patient Identity Feed FHIR by the Manager that Updates a Patient](StructureDefinition-IHE.PIXm.Feed.Update.Audit.Manager.md)
...
```json
{
  ...
  "id" : "ex-auditPixmFeed-update-manager",
  "meta" : {
    "profile" : [
