# Client - Audit Example of a basic patient identifiable Create of a Report with no user - Basic Audit Log Patterns (BALP) v1.1.4

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Client - Audit Example of a basic patient identifiable Create of a Report with no user**

## Example AuditEvent: Client - Audit Example of a basic patient identifiable Create of a Report with no user
...
```json
{
  ...
  "id" : "ex-auditBasicCreateNoUserReport",
  "meta" : {
    "profile" : [
