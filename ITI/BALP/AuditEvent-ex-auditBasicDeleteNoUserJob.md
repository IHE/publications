# Client - Audit Example of a basic patient identifiable Delete of a Job with no user - Basic Audit Log Patterns (BALP) v1.1.4

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Client - Audit Example of a basic patient identifiable Delete of a Job with no user**

## Example AuditEvent: Client - Audit Example of a basic patient identifiable Delete of a Job with no user
...
```json
{
  ...
  "id" : "ex-auditBasicDeleteNoUserJob",
  "meta" : {
    "profile" : [
