# Server - Audit Example of a basic patient identifiable Update by the informant - Basic Audit Log Patterns (BALP) v1.1.4

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Server - Audit Example of a basic patient identifiable Update by the informant**

## Example AuditEvent: Server - Audit Example of a basic patient identifiable Update by the informant
...
> **agent****type**:Informant**who**: Betty Jones**requestor**: true
