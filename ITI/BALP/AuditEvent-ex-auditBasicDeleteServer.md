# Server - Audit Example of a basic patient identifiable Delete at server - Basic Audit Log Patterns (BALP) v1.1.4

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Server - Audit Example of a basic patient identifiable Delete at server**

## Example AuditEvent: Server - Audit Example of a basic patient identifiable Delete at server
