# Server - Audit Example of a basic patient identifiable Update of a Report with no user - Basic Audit Log Patterns (BALP) v1.1.4

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Server - Audit Example of a basic patient identifiable Update of a Report with no user**

## Example AuditEvent: Server - Audit Example of a basic patient identifiable Update of a Report with no user
...
```json
{
  ...
  "id" : "ex-auditBasicUpdateNoUserReport",
  "meta" : {
    "profile" : [
