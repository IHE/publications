# Basic AuditEvent for a successful Read - Basic Audit Log Patterns (BALP) v1.1.4
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/ITI/BALP/StructureDefinition/IHE.BasicAudit.Read | *Version*:1.1.4 |
...
* Derived from this Profile: [Basic AuditEvent for a successful Read with a Patient](StructureDefinition-IHE.BasicAudit.PatientRead.md)
* Examples for this Profile: [AuditEvent/ex-auditBasicReadNoPatient](AuditEvent-ex-auditBasicReadNoPatient.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ihe.iti.balp|current/StructureDefinition/IHE.BasicAudit.Read)
...
Other representations of profile: [CSV](StructureDefinition-IHE.BasicAudit.Read.csv), [Excel](StructureDefinition-IHE.BasicAudit.Read.xlsx), [Schematron](StructureDefinition-IHE.BasicAudit.Read.sch) 
...
```json
{
  ...
  "url" : "https://profiles.ihe.net/ITI/BALP/StructureDefinition/IHE.BasicAudit.Read",
  "version" : "1.1.4",
  "name" : "Read",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "https://profiles.ihe.net/ITI/BALP/ValueSet/AllReadVS"
        }
      },
      {
