# Server - Audit Example of a basic patient identifiable Update using Patch - Basic Audit Log Patterns (BALP) v1.1.4

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Server - Audit Example of a basic patient identifiable Update using Patch**

## Example AuditEvent: Server - Audit Example of a basic patient identifiable Update using Patch
...
**subtype**: [FHIR Restful Interactions: patch](http://hl7.org/fhir/R4/codesystem-restful-interaction.html#restful-interaction-patch) (patch)
