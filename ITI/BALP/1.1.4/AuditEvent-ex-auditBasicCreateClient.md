# Client - Audit Example of a basic patient identifiable Create by the author - Basic Audit Log Patterns (BALP) v1.1.4

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Client - Audit Example of a basic patient identifiable Create by the author**

## Example AuditEvent: Client - Audit Example of a basic patient identifiable Create by the author
