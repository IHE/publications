# Basic Audit Log Patterns (BALP) - Basic Audit Log Patterns (BALP) v1.1.4
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/ITI/BALP/ImplementationGuide/ihe.iti.balp | *Version*:1.1.4 |
| Active as of 2025-10-31 | *Computable Name*:IHE_ITI_BALP |
...
* Volume 1: Profiles 
* [BasicAudit Introduction](volume-1.md)
* [BasicAudit Actors and Content](volume-1.md#1521-basicaudit-actors-and-content)
* [BasicAudit Actor Options](volume-1.md#1522-basicaudit-actor-options)
* [BasicAudit Required Groupings](volume-1.md#1523-basicaudit-required-actor-grouping)
* [BasicAudit Overview](volume-1.md#1524-basicaudit-overview)
* [BasicAudit Security Considerations](volume-1.md#1525-basicaudit-security-considerations)
* [BasicAudit Cross-Profile Considerations](volume-1.md#1526-basicaudit-cross-profile-considerations)
 
* Volume 3: Content Section 
* [Basic Audit Log Patterns](content.md) 
* [Scope](content.md#3571-scope)
* [Content](content.md#3572-content)
...
* [AuditEvent Use in IHE Profiles](appendix.md)
