# Server - Audit Example of a basic patient identifiable read with no user - Basic Audit Log Patterns (BALP) v1.1.4

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Server - Audit Example of a basic patient identifiable read with no user**

## Example AuditEvent: Server - Audit Example of a basic patient identifiable read with no user
...
> **entity****what**: Identifier: c07cf648-f068-4dd9-9411-8e69ca07d525**type**:[Entity Types that are defined in IHE BasicAudit: XrequestId](CodeSystem-BasicAuditEntityType.md#BasicAuditEntityType-XrequestId)(transport specific unique identifier where http X-Request-Id is used)
...
```json
{
  ...
  "entity" : [
    ...
    },
    {
      "what" : {
        "identifier" : {
          "value" : "c07cf648-f068-4dd9-9411-8e69ca07d525"
        }
      },
      "type" : {
