# Client - Audit Example of a basic patient identifiable Query (GET) - Basic Audit Log Patterns (BALP) v1.1.4
...
* recorded by the client peer [server](AuditEvent-ex-auditBasicQueryGetServer.md)
...
```json
{
  ...
  "id" : "ex-auditBasicQueryGetClient",
  "meta" : {
    "profile" : [
