# Server - Audit Example of a basic patient identifiable Delete by Informant - Basic Audit Log Patterns (BALP) v1.1.4

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Server - Audit Example of a basic patient identifiable Delete by Informant**

## Example AuditEvent: Server - Audit Example of a basic patient identifiable Delete by Informant
...
```json
{
  ...
  "id" : "ex-auditBasicDeleteInformant",
  "meta" : {
    "profile" : [
