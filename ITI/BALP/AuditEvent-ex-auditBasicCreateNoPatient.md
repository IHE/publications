# Server - Audit Example of a basic Create - Basic Audit Log Patterns (BALP) v1.1.4

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Server - Audit Example of a basic Create**

## Example AuditEvent: Server - Audit Example of a basic Create

Profile: [Basic AuditEvent for a successful Create not related to a Patient](StructureDefinition-IHE.BasicAudit.Create.md)
...
```json
{
  ...
  "id" : "ex-auditBasicCreateNoPatient",
  "meta" : {
    "profile" : [
