# DocumentReference Example for FHIR Imaging Study Manifest - Manifest-based Access to DICOM Objects (MADO) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **DocumentReference Example for FHIR Imaging Study Manifest**

## Example DocumentReference: DocumentReference Example for FHIR Imaging Study Manifest
...
| :--- | :--- | :--- |
| - | **Code** | **Target** |
| * | Transforms | [DocumentReference: extension = Magnetic Resonance,Lower limb structure; masterIdentifier = urn:dicom:uid#DICOM Unique Id#1.2.392.200140.2.1.1.1.2.799008771.2076.1519721309.448 (use: usual, ); identifier = urn:dicom:uid#DICOM Unique Id#1.2.392.200140.2.1.1.1.2.799008771.2076.1519721309.448 (use: usual, ); status = current; type = Diagnostic imaging study; category = Diagnostic imaging study; date = 2025-05-08 00:00:00+0000](DocumentReference-DocumentReferenceKOS.md) |
...
| * | application/fhir+json | German (Germany) | Bundle/fhir-manifest-bundle | 2025-05-08 00:00:00+0000 |
