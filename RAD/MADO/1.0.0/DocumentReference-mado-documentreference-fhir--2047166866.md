# mado-documentreference-fhir--2047166866 - Manifest-based Access to DICOM Objects (MADO) v1.0.0
...
**masterIdentifier**: `http://example.org/fhir/document-ids`/mado-bundle--2047166866

**identifier**: `http://example.org/fhir/document-ids`/mado-bundle--2047166866
...
| * | application/fhir+json | [Bundle: identifier = http://example.org/fhir/document-ids#mado-bundle--2047166866; type = document; timestamp = 2026-06-19 17:00:57+0200](Bundle-mado-bundle--2047166866.md) | FHIR Imaging Manifest for Imaging Study | 2026-06-19 17:00:57+0200 |
...
```json
{
  ...
  "id" : "mado-documentreference-fhir--2047166866",
  "extension" : [{
  ...
  "content" : [{
    ...
    "attachment" : {
      ...
      "url" : "Bundle/mado-bundle--2047166866",
