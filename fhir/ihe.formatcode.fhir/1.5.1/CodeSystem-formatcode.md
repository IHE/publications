# FormatCode CodeSystem - IHE FormatCode Vocabulary v1.5.1-current
...
| | |
| :--- | :--- |
| *Official URL*:http://ihe.net/fhir/ihe.formatcode.fhir/CodeSystem/formatcode | *Version*:1.5.1-current |
...
```json
{
  ...
  },
  {
    ...
    },
    {
      ...
      "display" : "RAD MADO",
      "definition" : "MADO Imaging Study Manifest in FHIR Format",
      "property" : [{
        "code" : "status",
        "valueCode" : "active"
      }]
