# FormatCode ValueSet - IHE FormatCode Vocabulary v1.5.1-current
...
| | |
| :--- | :--- |
| *Official URL*:http://ihe.net/fhir/ihe.formatcode.fhir/ValueSet/formatcode | *Version*:1.5.1-current |
