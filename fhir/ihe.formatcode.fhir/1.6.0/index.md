...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-09-11T11:58:42-05:00",
  ...
  "description" : "Implementation Guide for IHE defined FormatCode vocabulary.",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "http://ihe.net/fhir/ihe.formatcode.fhir/CodeSystem/formatcode"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "http://ihe.net/fhir/ihe.formatcode.fhir/ValueSet/formatcode"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://profiles.ihe.net/fhir/ihe.formatcode.fhir/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      "name" : "FormatCode CodeSystem",
      "description" : "All the FormatCode code values assigned by IHE",
    ...
    },
    {
      ...
      "name" : "FormatCode ValueSet",
      "description" : "A ValueSet of all the FormatCode code values assigned by IHE",
      "exampleBoolean" : false
    },
    {
      "extension" : [{
      ...
      "reference" : {
        "reference" : "Bundle/history-IHE-formatcode.codesystem"
      },
      "name" : "History of changes to formatCode codeSystem",
      "description" : "All of the changes to the codeSystem are represented as Provenance resources.",
      "exampleBoolean" : false
    },
    {
      "extension" : [{
      ...
      "reference" : {
        "reference" : "Bundle/history-IHE-formatcode.valueset"
      },
      "name" : "History of changes to formatCode ValueSet",
      "description" : "All of the changes to the ValueSet are represented as Provenance resources.",
      "exampleBoolean" : false
    }],
    "page" : {
      "extension" : [{
